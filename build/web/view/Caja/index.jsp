...
<a href="<c:url value="/${url}?option=add"/>" class="btn btn-success">Aperturar Nueva Caja</a>
		            ...
		            <tbody>
                                ...
                                <c:forEach items="${list}" var="row2">
                                    ...
                                    <c:forEach begin="1" end="${cant}" step="1" var="k">
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${row2[5]=='0'}">
                                                    <a class="btn btn-mini btn-danger" href="close_caja()">Cerrar</a>
                                                </c:when>
                                                 <c:when test="${row2[5]=='1' && row2[1]==row2[6] }">
                                                    <a class="btn" href="">Reaperturar</a>
                                                </c:when>
                                                     <c:when test="${row2[5]=='1'}">
                                                    <a class="btn" href="">###</a>
                                                </c:when>
