...
<div id="" class="ui-corner-all">
    ...
    <td>
        <input type="text" name="fechapago" value="${fechapago}" id="fechapago"/>
              </td>
...
<div class="alert" id="alert"></div>
   ...
   <script src="http://<%out.print(sHostNameg);%>:8080/script/bootstrap/js/bootstrap-datepicker.js" type="text/javascript"></script>
<link href="http://<%out.print(sHostNamem);%>:8080/script/bootstrap/css/datepicker.css" rel="stylesheet">
